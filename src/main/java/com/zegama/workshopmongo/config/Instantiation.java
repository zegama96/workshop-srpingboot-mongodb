package com.zegama.workshopmongo.config;
...
import com.zegama.workshopmongo.dto.AuthorDTO;
import com.zegama.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Parti de viagem", "Vou viajar para São paulo. Abraços!", new AuthorDTO(maria));
